...
class DataprocMetastoreTransport(abc.ABC):
    ...
    def get_service(
        ...
        typing.Union[metastore.Service, typing.Awaitable[metastore.Service]],
    ]:
        raise NotImplementedError()
    ...
    def get_metadata_import(
        ...
        typing.Union[
            metastore.MetadataImport, typing.Awaitable[metastore.MetadataImport]
        ],
    ]:
        raise NotImplementedError()
    ...
    def get_backup(
        ...
        typing.Union[metastore.Backup, typing.Awaitable[metastore.Backup]],
    ]:
        raise NotImplementedError()
