...
from google.cloud.metastore_v1beta.services.dataproc_metastore_federation import DataprocMetastoreFederationAsyncClient
from google.cloud.metastore_v1beta.services.dataproc_metastore_federation import DataprocMetastoreFederationClient
from google.cloud.metastore_v1beta.services.dataproc_metastore_federation import pagers
from google.cloud.metastore_v1beta.services.dataproc_metastore_federation import transports
...
def test_dataproc_metastore_federation_client_client_options_from_dict():
    with mock.patch('google.cloud.metastore_v1beta.services.dataproc_metastore_federation.transports.DataprocMetastoreFederationGrpcTransport.__init__') as grpc_transport:
...
def test_list_federations_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta/{parent=projects/*/locations/*}/federations" % client.transport._host, args[1])
...
def test_get_federation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/federations/*}" % client.transport._host, args[1])
...
def test_update_federation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{federation.name=projects/*/locations/*/federations/*}" % client.transport._host, args[1])
...
def test_dataproc_metastore_federation_base_transport():
    ...
    with mock.patch('google.cloud.metastore_v1beta.services.dataproc_metastore_federation.transports.DataprocMetastoreFederationTransport.__init__') as Transport:
...
def test_dataproc_metastore_federation_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.metastore_v1beta.services.dataproc_metastore_federation.transports.DataprocMetastoreFederationTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_dataproc_metastore_federation_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.metastore_v1beta.services.dataproc_metastore_federation.transports.DataprocMetastoreFederationTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DataprocMetastoreFederationTransport()
        adc.assert_called_once()
