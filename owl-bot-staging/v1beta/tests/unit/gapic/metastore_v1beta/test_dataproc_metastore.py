...
from google.cloud.metastore_v1beta.services.dataproc_metastore import DataprocMetastoreAsyncClient
...
def test_dataproc_metastore_client_client_options_from_dict():
    with mock.patch('google.cloud.metastore_v1beta.services.dataproc_metastore.transports.DataprocMetastoreGrpcTransport.__init__') as grpc_transport:
...
def test_list_services_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta/{parent=projects/*/locations/*}/services" % client.transport._host, args[1])
...
def test_get_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/services/*}" % client.transport._host, args[1])
...
def test_update_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{service.name=projects/*/locations/*/services/*}" % client.transport._host, args[1])
...
def test_list_metadata_imports_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{parent=projects/*/locations/*/services/*}/metadataImports" % client.transport._host, args[1])
...
def test_get_metadata_import_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/services/*/metadataImports/*}" % client.transport._host, args[1])
...
def test_update_metadata_import_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{metadata_import.name=projects/*/locations/*/services/*/metadataImports/*}" % client.transport._host, args[1])
...
def test_restore_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{service=projects/*/locations/*/services/*}:restore" % client.transport._host, args[1])
...
def test_list_backups_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{parent=projects/*/locations/*/services/*}/backups" % client.transport._host, args[1])
...
def test_get_backup_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/services/*/backups/*}" % client.transport._host, args[1])
...
def test_dataproc_metastore_base_transport():
    ...
    with mock.patch('google.cloud.metastore_v1beta.services.dataproc_metastore.transports.DataprocMetastoreTransport.__init__') as Transport:
...
def test_dataproc_metastore_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.metastore_v1beta.services.dataproc_metastore.transports.DataprocMetastoreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_dataproc_metastore_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.metastore_v1beta.services.dataproc_metastore.transports.DataprocMetastoreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DataprocMetastoreTransport()
        adc.assert_called_once()
