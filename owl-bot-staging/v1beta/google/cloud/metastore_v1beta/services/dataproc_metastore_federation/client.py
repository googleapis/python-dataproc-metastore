...
class DataprocMetastoreFederationClient(metaclass=DataprocMetastoreFederationClientMeta):
    ...
    def federation_path(project: str,location: str,federation: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/federations/{federation}".format(project=project, location=location, federation=federation, )

    @staticmethod
    def parse_federation_path(path: str) -> Dict[str,str]:
        """Parses a federation path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/federations/(?P<federation>.+?)$", path)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, DataprocMetastoreFederationTransport]] = None,
        ...
        if isinstance(transport, DataprocMetastoreFederationTransport):
    ...
    def list_federations(self,
        ...
        # in a metastore_federation.ListFederationsRequest.
    ...
    def get_federation(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a metastore_federation.GetFederationRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def create_federation(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a metastore_federation.CreateFederationRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def update_federation(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a metastore_federation.UpdateFederationRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_federation(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a metastore_federation.DeleteFederationRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
