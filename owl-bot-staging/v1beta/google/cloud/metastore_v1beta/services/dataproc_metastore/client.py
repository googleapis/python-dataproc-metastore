...
class DataprocMetastoreClient(metaclass=DataprocMetastoreClientMeta):
    ...
    def lake_path(project: str,location: str,lake: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/lakes/{lake}".format(project=project, location=location, lake=lake, )

    @staticmethod
    def parse_lake_path(path: str) -> Dict[str,str]:
        """Parses a lake path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/lakes/(?P<lake>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def list_metadata_imports(self,
    ...
    def create_metadata_import(self,
    ...
    def update_metadata_import(self,
    ...
    def remove_iam_policy(self,
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a metastore.RemoveIamPolicyRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def query_metadata(self,
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a metastore.QueryMetadataRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def move_table_to_database(self,
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a metastore.MoveTableToDatabaseRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def alter_metadata_resource_location(self,
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a metastore.AlterMetadataResourceLocationRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.alter_metadata_resource_location]
