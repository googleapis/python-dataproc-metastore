...
from google.cloud.metastore_v1.services.dataproc_metastore import DataprocMetastoreAsyncClient
...
from google.cloud.metastore_v1.services.dataproc_metastore import transports
...
def test_dataproc_metastore_client_client_options_from_dict():
    with mock.patch('google.cloud.metastore_v1.services.dataproc_metastore.transports.DataprocMetastoreGrpcTransport.__init__') as grpc_transport:
...
def test_list_services_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/services" % client.transport._host, args[1])
...
def test_get_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/services/*}" % client.transport._host, args[1])
...
def test_update_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{service.name=projects/*/locations/*/services/*}" % client.transport._host, args[1])
...
def test_list_metadata_imports_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/services/*}/metadataImports" % client.transport._host, args[1])
...
def test_get_metadata_import_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/services/*/metadataImports/*}" % client.transport._host, args[1])
...
def test_create_metadata_import_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/services/sample3'}
    request_init["metadata_import"] = {'database_dump': {'database_type': 1, 'gcs_uri': 'gcs_uri_value', 'type_': 1}, 'name': 'name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'end_time': {}, 'state': 1}
    request = request_type(**request_init)
...
def test_update_metadata_import_rest(request_type):
    ...
    request_init["metadata_import"] = {'database_dump': {'database_type': 1, 'gcs_uri': 'gcs_uri_value', 'type_': 1}, 'name': 'projects/sample1/locations/sample2/services/sample3/metadataImports/sample4', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'end_time': {}, 'state': 1}
    request = request_type(**request_init)
...
def test_update_metadata_import_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{metadata_import.name=projects/*/locations/*/services/*/metadataImports/*}" % client.transport._host, args[1])
...
def test_restore_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{service=projects/*/locations/*/services/*}:restore" % client.transport._host, args[1])
...
def test_list_backups_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/services/*}/backups" % client.transport._host, args[1])
...
def test_get_backup_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/services/*/backups/*}" % client.transport._host, args[1])
...
def test_create_backup_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/services/sample3'}
    request_init["backup"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'end_time': {}, 'state': 1, 'service_revision': {'hive_metastore_config': {'version': 'version_value', 'config_overrides': {}, 'kerberos_config': {'keytab': {'cloud_secret': 'cloud_secret_value'}, 'principal': 'principal_value', 'krb5_config_gcs_uri': 'krb5_config_gcs_uri_value'}, 'auxiliary_versions': {}}, 'name': 'name_value', 'create_time': {}, 'update_time': {}, 'labels': {}, 'network': 'network_value', 'endpoint_uri': 'endpoint_uri_value', 'port': 453, 'state': 1, 'state_message': 'state_message_value', 'artifact_gcs_uri': 'artifact_gcs_uri_value', 'tier': 1, 'maintenance_window': {'hour_of_day': {'value': 541}, 'day_of_week': 1}, 'uid': 'uid_value', 'metadata_management_activity': {'metadata_exports': [{'destination_gcs_uri': 'destination_gcs_uri_value', 'start_time': {}, 'end_time': {}, 'state': 1, 'database_dump_type': 1}], 'restores': [{'start_time': {}, 'end_time': {}, 'state': 1, 'backup': 'backup_value', 'type_': 1, 'details': 'details_value'}]}, 'release_channel': 1, 'encryption_config': {'kms_key': 'kms_key_value'}, 'network_config': {'consumers': [{'subnetwork': 'subnetwork_value', 'endpoint_uri': 'endpoint_uri_value'}]}, 'database_type': 1, 'telemetry_config': {'log_format': 1}, 'scaling_config': {'instance_size': 1, 'scaling_factor': 0.1471}}, 'description': 'description_value', 'restoring_services': ['restoring_services_value1', 'restoring_services_value2']}
    request = request_type(**request_init)
...
def test_dataproc_metastore_base_transport():
    ...
    with mock.patch('google.cloud.metastore_v1.services.dataproc_metastore.transports.DataprocMetastoreTransport.__init__') as Transport:
...
def test_dataproc_metastore_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.metastore_v1.services.dataproc_metastore.transports.DataprocMetastoreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_dataproc_metastore_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.metastore_v1.services.dataproc_metastore.transports.DataprocMetastoreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DataprocMetastoreTransport()
        adc.assert_called_once()
