...
from google.cloud.metastore_v1alpha.services.dataproc_metastore_federation import DataprocMetastoreFederationAsyncClient
from google.cloud.metastore_v1alpha.services.dataproc_metastore_federation import DataprocMetastoreFederationClient
from google.cloud.metastore_v1alpha.services.dataproc_metastore_federation import pagers
from google.cloud.metastore_v1alpha.services.dataproc_metastore_federation import transports
...
@pytest.mark.parametrize("client_class,transport_name", [
    (DataprocMetastoreFederationClient, "grpc"),
    (DataprocMetastoreFederationAsyncClient, "grpc_asyncio"),
    (DataprocMetastoreFederationClient, "rest"),
])
...
@pytest.mark.parametrize("transport_class,transport_name", [
    (transports.DataprocMetastoreFederationGrpcTransport, "grpc"),
    (transports.DataprocMetastoreFederationGrpcAsyncIOTransport, "grpc_asyncio"),
    (transports.DataprocMetastoreFederationRestTransport, "rest"),
])
...
def test_dataproc_metastore_federation_client_get_transport_class():
    ...
    available_transports = [
        transports.DataprocMetastoreFederationGrpcTransport,
        transports.DataprocMetastoreFederationRestTransport,
    ]
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (DataprocMetastoreFederationClient, transports.DataprocMetastoreFederationGrpcTransport, "grpc"),
    (DataprocMetastoreFederationAsyncClient, transports.DataprocMetastoreFederationGrpcAsyncIOTransport, "grpc_asyncio"),
    (DataprocMetastoreFederationClient, transports.DataprocMetastoreFederationRestTransport, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (DataprocMetastoreFederationClient, transports.DataprocMetastoreFederationGrpcTransport, "grpc", "true"),
    (DataprocMetastoreFederationAsyncClient, transports.DataprocMetastoreFederationGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (DataprocMetastoreFederationClient, transports.DataprocMetastoreFederationGrpcTransport, "grpc", "false"),
    (DataprocMetastoreFederationAsyncClient, transports.DataprocMetastoreFederationGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (DataprocMetastoreFederationClient, transports.DataprocMetastoreFederationRestTransport, "rest", "true"),
    (DataprocMetastoreFederationClient, transports.DataprocMetastoreFederationRestTransport, "rest", "false"),
])
@mock.patch.object(DataprocMetastoreFederationClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DataprocMetastoreFederationClient))
@mock.patch.object(DataprocMetastoreFederationAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DataprocMetastoreFederationAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (DataprocMetastoreFederationClient, transports.DataprocMetastoreFederationGrpcTransport, "grpc", grpc_helpers),
    (DataprocMetastoreFederationAsyncClient, transports.DataprocMetastoreFederationGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (DataprocMetastoreFederationClient, transports.DataprocMetastoreFederationRestTransport, "rest", None),
])
...
def test_dataproc_metastore_federation_client_client_options_from_dict():
    with mock.patch('google.cloud.metastore_v1alpha.services.dataproc_metastore_federation.transports.DataprocMetastoreFederationGrpcTransport.__init__') as grpc_transport:
...
def test_list_federations(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.list_federations),
            '__call__') as call:
...
def test_list_federations_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, metastore_federation.Federation)
                   for i in results)
...
async def test_list_federations_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_federations(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_federation(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_federation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_federation(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_federation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_federation_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_federation(
            parent='parent_value',
            federation=metastore_federation.Federation(name='name_value'),
...
async def test_create_federation_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.create_federation(
            metastore_federation.CreateFederationRequest(),
            parent='parent_value',
            federation=metastore_federation.Federation(name='name_value'),
            federation_id='federation_id_value',
...
def test_update_federation(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_federation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
async def test_update_federation_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.update_federation(
            metastore_federation.UpdateFederationRequest(),
            federation=metastore_federation.Federation(name='name_value'),
            update_mask=field_mask_pb2.FieldMask(paths=['paths_value']),
        )
...
def test_delete_federation(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_federation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
async def test_delete_federation_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_federation(
            metastore_federation.DeleteFederationRequest(),
            name='name_value',
        )
...
def test_list_federations_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        pb_return_value = metastore_federation.ListFederationsResponse.pb(return_value)
...
def test_list_federations_rest_interceptors(null_interceptor):
    transport = transports.DataprocMetastoreFederationRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.DataprocMetastoreFederationRestInterceptor(),
        )
    client = DataprocMetastoreFederationClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataprocMetastoreFederationRestInterceptor, "post_list_federations") as post, \
         mock.patch.object(transports.DataprocMetastoreFederationRestInterceptor, "pre_list_federations") as pre:
...
def test_list_federations_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*}/federations" % client.transport._host, args[1])
...
def test_get_federation_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = metastore_federation.Federation.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_federation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataprocMetastoreFederationRestInterceptor, "post_get_federation") as post, \
         mock.patch.object(transports.DataprocMetastoreFederationRestInterceptor, "pre_get_federation") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_federation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/federations/*}" % client.transport._host, args[1])
...
def test_create_federation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.DataprocMetastoreFederationRestInterceptor, "post_create_federation") as post, \
         mock.patch.object(transports.DataprocMetastoreFederationRestInterceptor, "pre_create_federation") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_federation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DataprocMetastoreFederationRestInterceptor, "post_update_federation") as post, \
         mock.patch.object(transports.DataprocMetastoreFederationRestInterceptor, "pre_update_federation") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_federation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{federation.name=projects/*/locations/*/federations/*}" % client.transport._host, args[1])
...
def test_delete_federation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DataprocMetastoreFederationRestInterceptor, "post_delete_federation") as post, \
         mock.patch.object(transports.DataprocMetastoreFederationRestInterceptor, "pre_delete_federation") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_credentials_transport_error():
    ...
    transport = transports.DataprocMetastoreFederationGrpcTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    with pytest.raises(ValueError):
        client = DataprocMetastoreFederationClient(
...
def test_transport_get_channel():
    ...
    transport = transports.DataprocMetastoreFederationGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_transport_kind(transport_name):
    transport = DataprocMetastoreFederationClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_dataproc_metastore_federation_base_transport():
    ...
    with mock.patch('google.cloud.metastore_v1alpha.services.dataproc_metastore_federation.transports.DataprocMetastoreFederationTransport.__init__') as Transport:
...
def test_dataproc_metastore_federation_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.metastore_v1alpha.services.dataproc_metastore_federation.transports.DataprocMetastoreFederationTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_dataproc_metastore_federation_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.metastore_v1alpha.services.dataproc_metastore_federation.transports.DataprocMetastoreFederationTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DataprocMetastoreFederationTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize(
    ...
    [
        (transports.DataprocMetastoreFederationGrpcTransport, grpc_helpers),
        (transports.DataprocMetastoreFederationGrpcAsyncIOTransport, grpc_helpers_async)
    ],
)
...
def test_dataproc_metastore_federation_client_transport_session_collision(transport_name):
    ...
    client1 = DataprocMetastoreFederationClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = DataprocMetastoreFederationClient(
        credentials=creds2,
        transport=transport_name,
    )
...
@pytest.mark.parametrize("transport_class", [transports.DataprocMetastoreFederationGrpcTransport, transports.DataprocMetastoreFederationGrpcAsyncIOTransport])
def test_dataproc_metastore_federation_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
@pytest.mark.parametrize("client_class,transport_class", [
    (DataprocMetastoreFederationClient, transports.DataprocMetastoreFederationGrpcTransport),
    (DataprocMetastoreFederationAsyncClient, transports.DataprocMetastoreFederationGrpcAsyncIOTransport),
])
