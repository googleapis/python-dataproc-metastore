...
from google.cloud.metastore_v1alpha.services.dataproc_metastore import DataprocMetastoreAsyncClient
from google.cloud.metastore_v1alpha.services.dataproc_metastore import DataprocMetastoreClient
from google.cloud.metastore_v1alpha.services.dataproc_metastore import pagers
from google.cloud.metastore_v1alpha.services.dataproc_metastore import transports
...
def test__get_default_mtls_endpoint():
    ...
    assert DataprocMetastoreClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert DataprocMetastoreClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert DataprocMetastoreClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert DataprocMetastoreClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
def test_dataproc_metastore_client_from_service_account_info(client_class, transport_name):
...
def test_dataproc_metastore_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_dataproc_metastore_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (DataprocMetastoreAsyncClient, transports.DataprocMetastoreGrpcAsyncIOTransport, "grpc_asyncio"),
...
def test_dataproc_metastore_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (DataprocMetastoreClient, transports.DataprocMetastoreRestTransport, "rest", "true"),
    (DataprocMetastoreClient, transports.DataprocMetastoreRestTransport, "rest", "false"),
])
@mock.patch.object(DataprocMetastoreClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DataprocMetastoreClient))
@mock.patch.object(DataprocMetastoreAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DataprocMetastoreAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_dataproc_metastore_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    DataprocMetastoreClient, DataprocMetastoreAsyncClient
])
@mock.patch.object(DataprocMetastoreClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DataprocMetastoreClient))
@mock.patch.object(DataprocMetastoreAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DataprocMetastoreAsyncClient))
...
def test_dataproc_metastore_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (DataprocMetastoreClient, transports.DataprocMetastoreGrpcTransport, "grpc", grpc_helpers),
    (DataprocMetastoreAsyncClient, transports.DataprocMetastoreGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (DataprocMetastoreClient, transports.DataprocMetastoreRestTransport, "rest", None),
])
def test_dataproc_metastore_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_dataproc_metastore_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_create_service_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_service(
            parent='parent_value',
            service=metastore.Service(hive_metastore_config=metastore.HiveMetastoreConfig(version='version_value')),
        ...
        assert arg == mock_val
        arg = args[0].service
        mock_val = metastore.Service(hive_metastore_config=metastore.HiveMetastoreConfig(version='version_value'))
        assert arg == mock_val
...
async def test_list_metadata_imports_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_metadata_imports(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_create_metadata_import_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_metadata_import(
            parent='parent_value',
            metadata_import=metastore.MetadataImport(database_dump=metastore.MetadataImport.DatabaseDump(database_type=metastore.MetadataImport.DatabaseDump.DatabaseType.MYSQL)),
        ...
        mock_val = metastore.MetadataImport(database_dump=metastore.MetadataImport.DatabaseDump(database_type=metastore.MetadataImport.DatabaseDump.DatabaseType.MYSQL))
        assert arg == mock_val
...
@pytest.mark.asyncio
async def test_remove_iam_policy_async(transport: str = 'grpc_asyncio', request_type=metastore.RemoveIamPolicyRequest):
    client = DataprocMetastoreAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(metastore.RemoveIamPolicyResponse(
            success=True,
        ))
...
def test_query_metadata(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.query_metadata),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_query_metadata_async(transport: str = 'grpc_asyncio', request_type=metastore.QueryMetadataRequest):
    client = DataprocMetastoreAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_move_table_to_database(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.move_table_to_database),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_move_table_to_database_async(transport: str = 'grpc_asyncio', request_type=metastore.MoveTableToDatabaseRequest):
    client = DataprocMetastoreAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_alter_metadata_resource_location(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.alter_metadata_resource_location),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_alter_metadata_resource_location_async(transport: str = 'grpc_asyncio', request_type=metastore.AlterMetadataResourceLocationRequest):
    client = DataprocMetastoreAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_services_rest_unset_required_fields():
    transport = transports.DataprocMetastoreRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_list_services_rest_interceptors(null_interceptor):
    transport = transports.DataprocMetastoreRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.DataprocMetastoreRestInterceptor(),
        )
    client = DataprocMetastoreClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_list_services") as post, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "pre_list_services") as pre:
        ...
        req.return_value._content = metastore.ListServicesResponse.to_json(metastore.ListServicesResponse())
...
def test_list_services_rest_bad_request(transport: str = 'rest', request_type=metastore.ListServicesRequest):
    client = DataprocMetastoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_services_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*}/services" % client.transport._host, args[1])
...
def test_get_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_get_service") as post, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "pre_get_service") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_service_rest_bad_request(transport: str = 'rest', request_type=metastore.GetServiceRequest):
    client = DataprocMetastoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/services/*}" % client.transport._host, args[1])
...
def test_create_service_rest_required_fields(request_type=metastore.CreateServiceRequest):
    transport_class = transports.DataprocMetastoreRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_service._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("request_id", "service_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_service_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "serviceId", )) & set(("parent", "serviceId", "service", )))
...
def test_create_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_create_service") as post, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "pre_create_service") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_service_rest_bad_request(transport: str = 'rest', request_type=metastore.CreateServiceRequest):
    client = DataprocMetastoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_service_rest_required_fields(request_type=metastore.UpdateServiceRequest):
    transport_class = transports.DataprocMetastoreRestTransport
...
def test_update_service_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("updateMask", "service", )))
...
def test_update_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_update_service") as post, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "pre_update_service") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_service_rest_bad_request(transport: str = 'rest', request_type=metastore.UpdateServiceRequest):
    client = DataprocMetastoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{service.name=projects/*/locations/*/services/*}" % client.transport._host, args[1])
...
def test_delete_service_rest_required_fields(request_type=metastore.DeleteServiceRequest):
    transport_class = transports.DataprocMetastoreRestTransport
...
def test_delete_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_delete_service") as post, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "pre_delete_service") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_service_rest_bad_request(transport: str = 'rest', request_type=metastore.DeleteServiceRequest):
    client = DataprocMetastoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_metadata_imports_rest_required_fields(request_type=metastore.ListMetadataImportsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_metadata_imports._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_metadata_imports_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_list_metadata_imports") as post, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "pre_list_metadata_imports") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metastore.ListMetadataImportsRequest.pb(metastore.ListMetadataImportsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = metastore.ListMetadataImportsResponse.to_json(metastore.ListMetadataImportsResponse())
        ...
        client.list_metadata_imports(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_metadata_imports_rest_bad_request(transport: str = 'rest', request_type=metastore.ListMetadataImportsRequest):
    client = DataprocMetastoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_metadata_imports_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*/services/*}/metadataImports" % client.transport._host, args[1])
...
def test_list_metadata_imports_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(metastore.ListMetadataImportsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_metadata_import_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/services/sample3/metadataImports/sample4'}
    request = request_type(**request_init)
...
def test_get_metadata_import_rest_required_fields(request_type=metastore.GetMetadataImportRequest):
    transport_class = transports.DataprocMetastoreRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_metadata_import._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_metadata_import_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_get_metadata_import") as post, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "pre_get_metadata_import") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metastore.GetMetadataImportRequest.pb(metastore.GetMetadataImportRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = metastore.MetadataImport.to_json(metastore.MetadataImport())
        ...
        client.get_metadata_import(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_metadata_import_rest_bad_request(transport: str = 'rest', request_type=metastore.GetMetadataImportRequest):
    client = DataprocMetastoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_metadata_import_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/services/sample3/metadataImports/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/services/*/metadataImports/*}" % client.transport._host, args[1])
...
def test_create_metadata_import_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/services/sample3'}
    request_init["metadata_import"] = {'database_dump': {'database_type': 1, 'gcs_uri': 'gcs_uri_value', 'source_database': 'source_database_value', 'type_': 1}, 'name': 'name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'end_time': {}, 'state': 1}
    request = request_type(**request_init)
...
def test_create_metadata_import_rest_required_fields(request_type=metastore.CreateMetadataImportRequest):
    transport_class = transports.DataprocMetastoreRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_metadata_import._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_metadata_import._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("metadata_import_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_metadata_import_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("metadataImportId", "requestId", )) & set(("parent", "metadataImportId", "metadataImport", )))
...
def test_create_metadata_import_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_create_metadata_import") as post, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "pre_create_metadata_import") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metastore.CreateMetadataImportRequest.pb(metastore.CreateMetadataImportRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_metadata_import(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_metadata_import_rest_bad_request(transport: str = 'rest', request_type=metastore.CreateMetadataImportRequest):
    client = DataprocMetastoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_metadata_import_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'metadata_import': {'name': 'projects/sample1/locations/sample2/services/sample3/metadataImports/sample4'}}
    request_init["metadata_import"] = {'database_dump': {'database_type': 1, 'gcs_uri': 'gcs_uri_value', 'source_database': 'source_database_value', 'type_': 1}, 'name': 'projects/sample1/locations/sample2/services/sample3/metadataImports/sample4', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'end_time': {}, 'state': 1}
    request = request_type(**request_init)
...
def test_update_metadata_import_rest_required_fields(request_type=metastore.UpdateMetadataImportRequest):
    transport_class = transports.DataprocMetastoreRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_metadata_import._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_metadata_import_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "updateMask", )) & set(("updateMask", "metadataImport", )))
...
def test_update_metadata_import_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_update_metadata_import") as post, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "pre_update_metadata_import") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metastore.UpdateMetadataImportRequest.pb(metastore.UpdateMetadataImportRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_metadata_import(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_metadata_import_rest_bad_request(transport: str = 'rest', request_type=metastore.UpdateMetadataImportRequest):
    client = DataprocMetastoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_metadata_import_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'metadata_import': {'name': 'projects/sample1/locations/sample2/services/sample3/metadataImports/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{metadata_import.name=projects/*/locations/*/services/*/metadataImports/*}" % client.transport._host, args[1])
...
def test_export_metadata_rest_required_fields(request_type=metastore.ExportMetadataRequest):
    transport_class = transports.DataprocMetastoreRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).export_metadata._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_export_metadata_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_export_metadata") as post, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "pre_export_metadata") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metastore.ExportMetadataRequest.pb(metastore.ExportMetadataRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.export_metadata(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_export_metadata_rest_bad_request(transport: str = 'rest', request_type=metastore.ExportMetadataRequest):
    client = DataprocMetastoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_restore_service_rest_required_fields(request_type=metastore.RestoreServiceRequest):
    transport_class = transports.DataprocMetastoreRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).restore_service._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_restore_service_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("service", "backup", )))
...
def test_restore_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_restore_service") as post, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "pre_restore_service") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metastore.RestoreServiceRequest.pb(metastore.RestoreServiceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.restore_service(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_restore_service_rest_bad_request(transport: str = 'rest', request_type=metastore.RestoreServiceRequest):
    client = DataprocMetastoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_restore_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'service': 'projects/sample1/locations/sample2/services/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{service=projects/*/locations/*/services/*}:restore" % client.transport._host, args[1])
...
def test_list_backups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_list_backups") as post, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "pre_list_backups") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = metastore.ListBackupsResponse.to_json(metastore.ListBackupsResponse())
...
def test_list_backups_rest_bad_request(transport: str = 'rest', request_type=metastore.ListBackupsRequest):
    client = DataprocMetastoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_backups_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*/services/*}/backups" % client.transport._host, args[1])
...
def test_get_backup_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/services/sample3/backups/sample4'}
    request = request_type(**request_init)
...
def test_get_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_get_backup") as post, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "pre_get_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_backup_rest_bad_request(transport: str = 'rest', request_type=metastore.GetBackupRequest):
    client = DataprocMetastoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_backup_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/services/sample3/backups/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/services/*/backups/*}" % client.transport._host, args[1])
...
def test_create_backup_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/services/sample3'}
    request_init["backup"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'end_time': {}, 'state': 1, 'service_revision': {'hive_metastore_config': {'version': 'version_value', 'config_overrides': {}, 'kerberos_config': {'keytab': {'cloud_secret': 'cloud_secret_value'}, 'principal': 'principal_value', 'krb5_config_gcs_uri': 'krb5_config_gcs_uri_value'}, 'endpoint_protocol': 1, 'auxiliary_versions': {}}, 'name': 'name_value', 'create_time': {}, 'update_time': {}, 'labels': {}, 'network': 'network_value', 'endpoint_uri': 'endpoint_uri_value', 'port': 453, 'state': 1, 'state_message': 'state_message_value', 'artifact_gcs_uri': 'artifact_gcs_uri_value', 'tier': 1, 'metadata_integration': {'data_catalog_config': {'enabled': True}, 'dataplex_config': {'lake_resources': {}}}, 'maintenance_window': {'hour_of_day': {'value': 541}, 'day_of_week': 1}, 'uid': 'uid_value', 'metadata_management_activity': {'metadata_exports': [{'destination_gcs_uri': 'destination_gcs_uri_value', 'start_time': {}, 'end_time': {}, 'state': 1, 'database_dump_type': 1}], 'restores': [{'start_time': {}, 'end_time': {}, 'state': 1, 'backup': 'backup_value', 'type_': 1, 'details': 'details_value'}]}, 'release_channel': 1, 'encryption_config': {'kms_key': 'kms_key_value'}, 'network_config': {'consumers': [{'subnetwork': 'subnetwork_value', 'endpoint_uri': 'endpoint_uri_value'}], 'custom_routes_enabled': True}, 'database_type': 1, 'telemetry_config': {'log_format': 1}, 'scaling_config': {'instance_size': 1, 'scaling_factor': 0.1471}}, 'description': 'description_value', 'restoring_services': ['restoring_services_value1', 'restoring_services_value2']}
    request = request_type(**request_init)
...
def test_create_backup_rest_required_fields(request_type=metastore.CreateBackupRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_backup._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("backup_id", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_backup_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("backupId", "requestId", )) & set(("parent", "backupId", "backup", )))
...
def test_create_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_create_backup") as post, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "pre_create_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_backup_rest_bad_request(transport: str = 'rest', request_type=metastore.CreateBackupRequest):
    client = DataprocMetastoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_delete_backup") as post, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "pre_delete_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_backup_rest_bad_request(transport: str = 'rest', request_type=metastore.DeleteBackupRequest):
    client = DataprocMetastoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_remove_iam_policy_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'resource': 'projects/sample1/locations/sample2/services/sample3/sample4'}
    request = request_type(**request_init)
...
def test_remove_iam_policy_rest_required_fields(request_type=metastore.RemoveIamPolicyRequest):
    transport_class = transports.DataprocMetastoreRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).remove_iam_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_remove_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_remove_iam_policy") as post, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "pre_remove_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metastore.RemoveIamPolicyRequest.pb(metastore.RemoveIamPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = metastore.RemoveIamPolicyResponse.to_json(metastore.RemoveIamPolicyResponse())
        ...
        client.remove_iam_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_remove_iam_policy_rest_bad_request(transport: str = 'rest', request_type=metastore.RemoveIamPolicyRequest):
    client = DataprocMetastoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_query_metadata_rest_required_fields(request_type=metastore.QueryMetadataRequest):
    transport_class = transports.DataprocMetastoreRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).query_metadata._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_query_metadata_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("service", "query", )))
...
def test_query_metadata_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_query_metadata") as post, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "pre_query_metadata") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.query_metadata(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_query_metadata_rest_bad_request(transport: str = 'rest', request_type=metastore.QueryMetadataRequest):
    client = DataprocMetastoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_move_table_to_database_rest_required_fields(request_type=metastore.MoveTableToDatabaseRequest):
    transport_class = transports.DataprocMetastoreRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).move_table_to_database._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_move_table_to_database_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("service", "tableName", "dbName", "destinationDbName", )))
...
def test_move_table_to_database_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_move_table_to_database") as post, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "pre_move_table_to_database") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metastore.MoveTableToDatabaseRequest.pb(metastore.MoveTableToDatabaseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.move_table_to_database(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_move_table_to_database_rest_bad_request(transport: str = 'rest', request_type=metastore.MoveTableToDatabaseRequest):
    client = DataprocMetastoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_alter_metadata_resource_location_rest_required_fields(request_type=metastore.AlterMetadataResourceLocationRequest):
    transport_class = transports.DataprocMetastoreRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).alter_metadata_resource_location._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_alter_metadata_resource_location_rest_unset_required_fields():
    ...
    unset_fields = transport.alter_metadata_resource_location._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("service", "resourceName", "locationUri", )))
...
def test_alter_metadata_resource_location_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "post_alter_metadata_resource_location") as post, \
         mock.patch.object(transports.DataprocMetastoreRestInterceptor, "pre_alter_metadata_resource_location") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metastore.AlterMetadataResourceLocationRequest.pb(metastore.AlterMetadataResourceLocationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.alter_metadata_resource_location(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_alter_metadata_resource_location_rest_bad_request(transport: str = 'rest', request_type=metastore.AlterMetadataResourceLocationRequest):
    client = DataprocMetastoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_dataproc_metastore_base_transport():
    ...
    with mock.patch('google.cloud.metastore_v1alpha.services.dataproc_metastore.transports.DataprocMetastoreTransport.__init__') as Transport:
...
def test_dataproc_metastore_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.metastore_v1alpha.services.dataproc_metastore.transports.DataprocMetastoreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_dataproc_metastore_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.metastore_v1alpha.services.dataproc_metastore.transports.DataprocMetastoreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DataprocMetastoreTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.DataprocMetastoreGrpcTransport, transports.DataprocMetastoreGrpcAsyncIOTransport])
def test_dataproc_metastore_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_dataproc_metastore_host_no_port(transport_name):
    client = DataprocMetastoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='metastore.googleapis.com'),
         transport=transport_name,
    )
    assert client.transport._host == (
        'metastore.googleapis.com:443'
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.DataprocMetastoreGrpcTransport, transports.DataprocMetastoreGrpcAsyncIOTransport])
def test_dataproc_metastore_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (DataprocMetastoreAsyncClient, transports.DataprocMetastoreGrpcAsyncIOTransport),
])
